        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center animate-fade-in-up">
            ...
            <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed">
              ...
              between academic excellence and industry application. CDF is
              envisioned as IIT Gandhinagar’s dedicated platform for advancing
              professional and technical competencies through innovative,
              hands-on, and industry-aligned programs. These programs, pioneered
              by IIT Gandhinagar through CDF, bring together the institute’s
              academic rigor, research expertise, and a strong network of
              industry collaborators to create meaningful pathways for
              upskilling and talent development. By offering intensive,
              residential, and application-driven programs in cutting-edge
              technology domains such as Artificial Intelligence, Data Science,
              Cloud Computing, Cybersecurity, Robotics, and Semiconductor
              Manufacturing, CDF aims to equip learners with the practical
              skills, depth of knowledge, and confidence to meet the evolving
              needs of modern industries. Guided by IIT Gandhinagar’s values of
              integrity, innovation, and impact, CDF is committed to shaping the
              next generation of skilled professionals who can contribute
              effectively to India’s technological advancement and global
              competitiveness.
            </p>
          </div>
        </div>
            ...
            <div className="space-y-10">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Postgraduate Diploma from IIT Gandhinagar with Executive
                    Alumni Status.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Live, learn, and build on campus with full access to IITGN
                    facilities.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Fortune-500 mentors guide your projects and conduct code
                    reviews.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    IITGN-CDF x Futurense placement assistance supports
                    qualified learners.
                  </p>
                </div>
              </div>
